            ...
            children: [
              ListTile(
                ...
                onTap: () async {
                  ...
                  const fbAppUrl = 'fb://page/elcontraste.co';
                  const fbWebUrl = 'https://www.facebook.com/ElContrasteNoticias';
              ...
              ListTile(
                ...
                onTap: () async {
                  Navigator.pop(context);
                  const twitterAppUrl = 'twitter://user?screen_name=elcontrastenoti';
                  const twitterWebUrl = 'https://x.com/elcontrastenoti';
                  if (await canLaunchUrl(Uri.parse(twitterAppUrl))) {
                    await launchUrl(Uri.parse(twitterAppUrl),
                        mode: LaunchMode.externalApplication);
                  } else if (await canLaunchUrl(Uri.parse(twitterWebUrl))) {
                    await launchUrl(Uri.parse(twitterWebUrl),
                        mode: LaunchMode.externalApplication);
                  } else {
                    debugPrint('No se pudo abrir $twitterAppUrl ni $twitterWebUrl');
                  }
                },
              ),
              ListTile(
                ...
                onTap: () {
                  Navigator.pop(context);
                  _launchURL('https://www.instagram.com/elcontrastenoticias/', context);
                },
              ),
              ListTile(
                leading: const FaIcon(
                ...
                onTap: () {
                  Navigator.pop(context);
                  _launchURL('https://www.youtube.com/@ElContrasteNoticias', context);
                },
              ),
              ListTile(
                leading: const FaIcon(
                ...
                onTap: () {
                  Navigator.pop(context);
                  _launchURL('https://www.tiktok.com/@el.contraste.noti', context);
                },
              ),
            ],
          ),
